...
public class MouseLook : MonoBehaviour {
	...
	void LateUpdate ()
    {
        //float rotationX=0;// = Input.GetAxis("Mouse X") * sensitivityX;
        //float rotationY=0;// = Input.GetAxis("Mouse Y") * sensitivityY;
        ...
        //transform.Rotate(new Vector3(-rotationY, rotationX, 0), Space.Self);

        //float distance = transform.localPosition.magnitude;
        ////transform.LookAt(GetComponent<FocusOn>().planetTrans);
